...
class FedMD():
    ...
    def collaborative_training(self):
        ...
        while True:
            ...
            # Update the list of indices for models with accuracy greater than the average
            ind = [index for index, acc in enumerate(round_accuracies) if acc > average_accuracy]
